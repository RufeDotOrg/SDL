...
*/
	...
	// AWN: Faster start-up time; remove extra window->fullscreen transition
	...
	// AWN: Removed situational command delays
    ...
    public static void setWindowStyle(boolean fullscreen) {
        // AWN: Log windowStyle changes
        Log.v(TAG, "setWindowStyle fullscreen: " + fullscreen);
        // Called from SDLMain() thread and can't directly affect the view
